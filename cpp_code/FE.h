...
class FE{
    public:
        ...
        std::vector<std::vector<double> > NC; /**<This is the Nodal Coordinate Matrix. NC[i] gives the x and y - coordinate of the ith global degree of freedom. Note: Each node has 'dimension' degrees of freedom. The size of this matrix will thus be  (No.of nodes, dim)*/
